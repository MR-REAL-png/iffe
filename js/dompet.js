// ═══ BANK THEMES ═══
const BANK_THEMES={
  'Jago':      {grad:'linear-gradient(135deg,#d97706,#fbbf24)',motif:'waves'},
  'Cash':      {grad:'linear-gradient(135deg,#059669,#34d399)',motif:'cash'},
  'BCA':       {grad:'linear-gradient(135deg,#1e40af,#3b82f6)',motif:'lines'},
  'Seabank':   {grad:'linear-gradient(135deg,#ea580c,#f97316)',motif:'triangles'},
  'Dana':      {grad:'linear-gradient(135deg,#2563eb,#7c3aed)',motif:'circles'},
  'Shopeepay': {grad:'linear-gradient(135deg,#dc2626,#f97316)',motif:'dots'},
  'GoPay':     {grad:'linear-gradient(135deg,#047857,#10b981)',motif:'waves'},
  'OVO':       {grad:'linear-gradient(135deg,#6d28d9,#8b5cf6)',motif:'circles'},
  'Mandiri':   {grad:'linear-gradient(135deg,#b45309,#f59e0b)',motif:'lines'},
  'BNI':       {grad:'linear-gradient(135deg,#1d4ed8,#3b82f6)',motif:'dots'},
  'BRI':       {grad:'linear-gradient(135deg,#991b1b,#dc2626)',motif:'waves'},
  'default':   {grad:'linear-gradient(135deg,#0ea5e9,#f472b6)',motif:'dots'},
};
